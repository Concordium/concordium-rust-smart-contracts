        ...
        .contract_invoke(
            ...
            UpdateContractPayload {
                ...
                receive_name: OwnedReceiveName::new_unchecked(
                    "cis2_multi_royalties.view".to_string(),
                ),
...
fn test_royalty_payment() {
    ...
    let invoke_1 = chain
        ...
        .expect("Invoke view");
    let rv: ViewState = invoke_1
        .parse_return_value()
        .expect("ViewState return value");
    assert_eq!(
        rv.state,
        vec![
            (
    ...
    let update = chain
        .contract_update(
            ...
            UpdateContractPayload {
                amount: Amount::zero(),
                receive_name: OwnedReceiveName::new_unchecked(
                    "cis2_multi_royalties.mint".to_string(),
                ),
                address: contract_address,
...
fn initialize_chain_and_contract() -> (Chain, ContractAddress) {
    ...
    let parameter = InitParams { pay_royalty: true };
        ...
        .contract_init(
            ...
            InitContractPayload {
                ...
                init_name: OwnedContractName::new_unchecked(
                    "init_cis2_multi_royalties".to_string(),
                ),
