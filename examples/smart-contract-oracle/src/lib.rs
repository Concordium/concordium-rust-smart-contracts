...
#[receive(contract = "oracle", name = "view", return_value = "Vec<(String, u64)>")]
fn view<'b>(_ctx: &ReceiveContext, host: &Host<State>) -> ReceiveResult<Vec<(String, u64)>> {
