    ...
    let _update_1 = chain
        .contract_update(
            ...
            UpdateContractPayload {
                ...
                receive_name: OwnedReceiveName::new_unchecked("sponsored_tx_enabled_auction.bid".to_string()),
    ...
    let update_6 = chain
        .contract_update(
            ...
            UpdateContractPayload {
                amount:       Amount::zero(),
                address:      contract_address,
                receive_name: OwnedReceiveName::new_unchecked("sponsored_tx_enabled_auction.finalize".to_string()),
                message:      OwnedParameter::empty(),
            },
        )
...
fn initialize_chain_and_auction() -> (Chain, ContractAddress) {
    ...
    let init = chain
        .contract_init(SIGNER, CAROL, Energy::from(10000), InitContractPayload {
            ...
            init_name: OwnedContractName::new_unchecked("init_sponsored_tx_enabled_auction".to_string()),
