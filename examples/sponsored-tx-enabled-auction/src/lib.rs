...
#[init(contract = "sponsored_tx_enabled_auction", parameter = "InitParameter")]
...
#[receive(contract = "sponsored_tx_enabled_auction", name = "bid", payable, mutable, error = "BidError")]
fn auction_bid(
    ctx: &ReceiveContext,
    host: &mut Host<State>,
    amount: Amount,
...
#[receive(contract = "sponsored_tx_enabled_auction", name = "view", return_value = "State")]
...
/// the contract
#[receive(contract = "sponsored_tx_enabled_auction", name = "viewHighestBid", return_value = "Amount")]
...
/// instance.
#[receive(contract = "sponsored_tx_enabled_auction", name = "finalize", mutable, error = "FinalizeError")]
