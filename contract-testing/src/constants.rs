...
/// [`verify_ed22519_cost`](concordium_smart_contract_engine::constants::
/// verify_ed25519_cost) except the latter is the cost in interpreter energy,
/// and this on is in [`Energy`].
