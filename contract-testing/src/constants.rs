...
/// instance.
pub(crate) const CONTRACT_INSTANCE_QUERY_CONTRACT_MODULE_REFERENCE_COST: Energy =
    Energy { energy: 200 };
...
/// on the length.
pub(crate) const CONTRACT_INSTANCE_QUERY_CONTRACT_NAME_COST: Energy = Energy { energy: 200 };
